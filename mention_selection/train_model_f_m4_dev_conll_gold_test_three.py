...
class Model_4(NN.Module):
    def __init__(self, use_gpu, lstm_size, hidden_size, drop_out_1, drop_out_2):
        ...
        self.linear1 = NN.Linear(lstm_size * 4, hidden_size)
    ...
    def forward(self, seql_1_list, seql_2_list, max_seql_length, rep_r, len_r, ent_seql_1_list, ent_seql_2_list, ent_sep_pos_list_l, ent_seqr_list, ent_sep_pos_list_r, max_ent_seql_length, max_ent_seqr_length, ent_mention_bit_l1, ent_mention_bit_l2, ent_mention_bit_r, ent_distance_l1, ent_distance_l2, ent_distance_r, first_mention_bit, second_mention_bit, focus_mention_length, other_mention_length, coreference_chain_length, used_bit_seql_1, same_bit_seql_1, used_bit_seql_2, same_bit_seql_2, is_subject_list, is_object_list):
        ...
        final_lstm_out_l1 = torch.cat((lstm_out_l1, ent_lstm_out_l1), 1)
        ...
        final_lstm_out_l2 = torch.cat((lstm_out_l2, ent_lstm_out_l2), 1)
                        ...
                        if not gold_setting:
                            if is_identified_verb == 1 and is_annotated_verb == 1:
                                ...
                                if write_result:
                                    ...
                                    f.write('\t')
                                    f.write("<start_pos>: ")
                                    f.write(int(raw_sequence_data._start_pos))
                                    f.write("\n")                                   
                                continue
                                ...
                                if annotated_original_verb.lower() != annotated_converted_verb.lower():
                                    total_annotated_verb_not_identified_incorrectly_converted = total_annotated_verb_not_identified_incorrectly_converted
                                    current_total_annotated_verb_not_identified_incorrectly_converted = current_total_annotated_verb_not_identified_incorrectly_converted
                                if write_result:
...
#                    f_temp.write('\n')
    ...
    def train_and_evaluate_scenario2(self, FLAGS):
        ...
        output_file = 'result_f_m4_dev_conll_gold_test_three' + ".txt"
        ...
        for i in range(num_epochs):
            ...
            file_name_auto = 'output_f_m4_dev_conll_gold_test_pov_auto' + str(i+1) + ".txt"
...
#            f_output.write("\n")
            ...
            #valid_losses, total_size_test_pov_gold, total_correct_test_pov_gold, total_se_error_test_pov_gold, total_entity_mention_not_in_mc_test_pov_gold, total_mention_selection_error_test_pov_gold, total_test_correct_gold, total_test_se_error_gold, total_test_entity_mention_not_in_mc_gold, total_test_mention_selection_error_gold=self.get_model_testing_data_scenario2(f_gold, pov_gold_testing_data_dir, model, margin, True, True)
            #valid_losses = []
            #print('Results on pov data - gold setting: ')                
            #print('total size: ')
            #print(total_size_test_pov_gold)
            #print('total correct: ')
            #print(total_correct_test_pov_gold)
            #print('total test correct: ')
            #print(total_test_correct_gold)
            #print('toal se error: ')
            #print(total_se_error_test_pov_gold)
            #print('total entity not in mc: ')
            #print(total_entity_mention_not_in_mc_test_pov_gold)
            #print('total mention selection error: ')
            #print(total_mention_selection_error_test_pov_gold+total_se_error_test_pov_gold)
            #print('total test mention selection error: ')
            #print(total_test_mention_selection_error_gold+total_test_se_error_gold)
            #f_output.write('Results on pov data - gold setting: ')
            #f_output.write('\n')
            #f_output.write('total size: ')
            #f_output.write("\n")
            #f_output.write(str(total_size_test_pov_gold))
            #f_output.write('\n')
            #f_output.write('total correct: ')
            #f_output.write('\n')
            #f_output.write(str(total_correct_test_pov_gold))
            #f_output.write('\n')
            #f_output.write('total test correct: ')
            #f_output.write('\n')
            #f_output.write(str(total_test_correct_gold))
            #f_output.write('\n')
            #f_output.write('toal se error: ')
            #f_output.write('\n')
            #f_output.write(str(total_se_error_test_pov_gold))
            #f_output.write('\n')
            #f_output.write('total entity not in mc: ')
            #f_output.write('\n')
            #f_output.write(str(total_entity_mention_not_in_mc_test_pov_gold))
            #f_output.write('\n')
            #f_output.write('total mention selection error: ')
            #f_output.write('\n')
            #f_output.write(str(total_mention_selection_error_test_pov_gold+total_se_error_test_pov_gold))
            #f_output.write('\n')
            #f_output.write('total test mention selection error: ')
            #f_output.write('\n')
            #f_output.write(str(total_test_mention_selection_error_gold+total_test_se_error_gold))
            #f_output.write('\n')
...
def main():
    ...
    #parser.add_argument('--conll_gold_testing_data_dir',
                    #type=str,
                    #default='mention_predictor/preprocess/preprocess_conll_data/output_conll_data/test/',
                    #help='Path of the testing data.')
    #parser.add_argument('--pov_gold_testing_data_dir',
                    #type=str,
                    #default='mention_predictor/preprocess/preprocess_pov_data/output_data/test_gold/',
                    #help='Path of the testing data.')
