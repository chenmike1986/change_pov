...
class RNNNet4(object):
    ...
    def evaluate(self, model, FLAGS):
        ...
        file_name_dev = 'output_f_m4_dev_conll_gold_test_pov_dev.txt'
        f_dev = open(file_name_dev, 'w+', encoding='utf-8')
        file_name_test = 'output_f_m4_dev_conll_gold_test_pov_test.txt'
...
#        print(total_size_dev)
    ...
    def train_and_evaluate_scenario2(self, FLAGS):
        ...
        for i in range(num_epochs):
            ...
            start_time = time.time()
            file_name_dev = 'output_f_m4_dev_conll_gold_test_pov_dev' + str(i+1) + ".txt"
            f_dev = open(file_name_dev, 'w+', encoding='utf-8')
            file_name_test = 'output_f_m4_dev_conll_gold_test_pov_test' + str(i+1) + ".txt"
            f_test = open(file_name_test, 'w+', encoding='utf-8')
