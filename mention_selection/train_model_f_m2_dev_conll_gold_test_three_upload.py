...
#                            total_correct = total_correct + 1
    ...
    def evaluate(self, model, FLAGS):
        ...
        file_name_gold = 'output_f_m2_dev_conll_gold_test_pov_gold.txt'
        f_gold = open(file_name_gold, 'w+', encoding='utf-8')
        file_name_dev = 'output_f_m2_dev_conll_gold_test_pov_dev.txt'
        f_dev = open(file_name_dev, 'w+', encoding='utf-8')
        file_name_test = 'output_f_m2_dev_conll_gold_test_pov_test.txt'
