...
class Model_5(NN.Module):
    def __init__(self, use_gpu, lstm_size, hidden_size, drop_out_1, drop_out_2):
        ...
        self.linear1 = NN.Linear(lstm_size * 4 + 18, hidden_size)
...
#                    
#                    print(data_path)
#                    print("current total annotated mention correctly identified: ")
#                    print(current_total_annotated_mention_correctly_identified)
...
#        pov_gold_testing_data_dir = FLAGS.pov_gold_testing_data_dir
        ...
        output_file = 'result_f_m5_dev_conll_gold_test_three' + ".txt"
...
#            file_name_gold = 'output_f_m5_dev_conll_gold_test_pov_gold' + str(i+1) + ".txt"
#            f_gold = open(file_name_gold, 'w+', encoding='utf-8')
            file_name_auto = 'output_f_m5_dev_conll_gold_test_pov_auto' + str(i+1) + ".txt"
...
#                    type=str,
#                    default='E:/mention_predictor_upload/code/mention_selection/temp1/conll_padding_scenario_2',
...
#    parser.add_argument('--conll_gold_testing_data_dir',
#                    type=str,
#                    default='/home/mc277509/mention_predictor/conll_data/dev/',
#                    help='Path of the testing data.')
#    parser.add_argument('--pov_gold_testing_data_dir',
#                    type=str,
