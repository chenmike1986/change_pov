...
class POVTransformer(object):
    ...
    def train_and_evaluate(self, FLAGS):       
        ...
        for i in range(num_epochs):
            ...
            print('training loss: %f' % (1.0*running_loss/3272))
            sys.stdout.flush()
            
            summary_writer.add_scalar('training loss', 1.0*running_loss/3272, i+1)
             
            model_path = "saved_models_new/model_epoch_"+str(i+1)+".pt"
...
def main():    
    ...
    parser.add_argument('--conll_data_dir',
                    type=str,
                    default='../generate_training_data/output_training_array/conll_padding',
