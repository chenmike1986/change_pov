...
This program can be run in two mode: training and testing, you need to specify the mode, the default is the testing mode (the training mode is 1):
--is_training 0 
...
the default prefix is "change_pov/preprocess/generate_training_data/output_training_array/conll_padding"). The training data is so big that we did not upload it. To generate 
...
--conll_data_dir change_pov/preprocess/generate_training_data/output_training_array/conll_padding
