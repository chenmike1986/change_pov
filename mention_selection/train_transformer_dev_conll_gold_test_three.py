...
class POVTransformer(object):
    ...
    def get_model_development_data(self, data_dir, model, margin=0.2, dropout_rate=0):
            ...
            for data_path in files:
                ...
                for raw_document_data in self.raw_document_data_list:
                    ...
                    for raw_sequence_data in raw_sequence_data_list:
                        ...
                        outputs = model(input_ids_1=input_ids_1, input_ids_2=input_ids_2, Y_1=Y_1, Y_2=Y_2, attention_mask_1=attention_mask_1, attention_mask_2=attention_mask_2, labels=labels, mention_pos_list_1=mapped_mention_pos_list_1, mention_pos_list_2=mapped_mention_pos_list_2,margin=margin, dr=dropout_rate)
                        loss = outputs.loss
        ...
        print('CoNLL total entity: ')
        print(total_entity)
        print('CoNLL total mention: ')
        print(total_size)
    ...
    def get_model_testing_data(self, f, f_temp, data_dir, model, gold_setting=False, write_result=False, margin=0.2, dropout_rate=0):
        ...
        with torch.no_grad():
            ...
            print('PoV total entity: ')
            print(total_entity)
            print('PoV total mention: ')
            print(total_size)
    ...
    def evaluate(self, model, FLAGS):
        ...
        # f_temp_dev = open('temp_dev_transformer.txt', 'w+', encoding='utf-8')
        # file_name_gold = 'output_f_transformer_dev_conll_gold_test_pov_gold.txt'
        # f_gold = open(file_name_gold, 'w+', encoding='utf-8')
        # file_name_dev = 'output_f_transformer_dev_conll_gold_test_pov_dev.txt'
        ...
        # valid_losses, total_size, total_correct, total_annotated_mention, total_annotated_mention_correctly_identified, total_annotated_mention_correctly_identified_correctly_converted, total_annotated_mention_incorrectly_identified, total_annotated_mention_incorrectly_identified_incorrectly_converted, total_annotated_mention_not_identified, total_annotated_mention_not_identified_incorrectly_converted, total_identified_mention_not_annotated, total_identified_mention_not_annotated_incorrectly_converted, total_annotated_verb, total_annotated_verb_correctly_identified, total_annotated_verb_correctly_identified_correctly_converted, total_annotated_verb_not_identified, total_annotated_verb_not_identified_incorrectly_converted, total_identified_verb_not_annotated, total_identified_verb_not_annotated_incorrectly_converted, total_se_error =self.get_model_testing_data(f_gold, f_temp_gold, pov_gold_testing_data_dir, model, True, True, margin, dropout_rate)
        # valid_losses = []
        ...
        # print('\t')
        # print("total identified mention not annotated incorrectly converted: ")
...
#         valid_losses, total_size, total_correct, total_annotated_mention, total_annotated_mention_correctly_identified, total_annotated_mention_correctly_identified_correctly_converted, total_annotated_mention_incorrectly_identified, total_annotated_mention_incorrectly_identified_incorrectly_converted, total_annotated_mention_not_identified, total_annotated_mention_not_identified_incorrectly_converted, total_identified_mention_not_annotated, total_identified_mention_not_annotated_incorrectly_converted, total_annotated_verb, total_annotated_verb_correctly_identified, total_annotated_verb_correctly_identified_correctly_converted, total_annotated_verb_not_identified, total_annotated_verb_not_identified_incorrectly_converted, total_identified_verb_not_annotated, total_identified_verb_not_annotated_incorrectly_converted, total_se_error=self.get_model_testing_data(f_dev, f_temp_dev, pov_auto_dev_data_dir, model, False, True, margin, dropout_rate)
#         valid_losses = []
...
#         f_output.write('\n')
        ...
        valid_losses, total_size, total_correct, total_annotated_mention, total_annotated_mention_correctly_identified, total_annotated_mention_correctly_identified_correctly_converted, total_annotated_mention_incorrectly_identified, total_annotated_mention_incorrectly_identified_incorrectly_converted, total_annotated_mention_not_identified, total_annotated_mention_not_identified_incorrectly_converted, total_identified_mention_not_annotated, total_identified_mention_not_annotated_incorrectly_converted, total_annotated_verb, total_annotated_verb_correctly_identified, total_annotated_verb_correctly_identified_correctly_converted, total_annotated_verb_not_identified, total_annotated_verb_not_identified_incorrectly_converted, total_identified_verb_not_annotated, total_identified_verb_not_annotated_incorrectly_converted, total_se_error=self.get_model_testing_data(f_test, f_temp_test, pov_auto_testing_data_dir, model, False, True, margin, dropout_rate)
        valid_losses = []
        ...
        f_output.write('Results on pov data - test: ')
        f_output.write("\n")
        f_output.write("total annotated mention: ")
        f_output.write(str(total_annotated_mention))
        f_output.write('\t')
...
def main():    
    ...
    parser.add_argument('--conll_data_dir',
                    type=str,
                    default='E:/mention_predictor_upload/code/preprocess/generate_training_data/output_training_array/conll_padding',
                    help='Directory to the conll training data.')
    parser.add_argument('--development_data_dir',
                    type=str,
                    default='conll_data/test_transformer/',
