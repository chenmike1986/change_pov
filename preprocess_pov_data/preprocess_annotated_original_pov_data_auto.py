    ...
    for sent_num in sentence_num_to_token_index_list:
        ...
        for i in range(len(token_index_list)):
            ...
            if start_pos in start_pos_to_identified_verb_conversion:
                identified_verbs[i]=i
                key = str(sent_num)+":"+str(i)
