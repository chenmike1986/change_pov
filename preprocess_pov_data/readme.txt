...
To run the program, you need to specify the directory of the annotated PoV articles ( the default directory is "input_data/"), 
the directory of output files, which will be used during evaluation ( the default directory is "output_data"), 
