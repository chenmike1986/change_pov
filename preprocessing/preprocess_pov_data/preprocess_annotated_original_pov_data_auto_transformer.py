...
def extract_singular_first_person_entity(document_text, start_pos_to_verb_conversion, start_pos_to_mention_conversion, highlight_color_to_cluster_id, shading_color_to_cluster_id, sentences, start_pos_to_token, start_pos_to_sentence_num):
    singular_first_person_mentions = ['i', 'me', 'my', 'myself','mine']
    ...
    speaking_patterns = [] 
    f = open('performatives.txt')
    lines = f.readlines()
    for line in lines:
        words = line.split(' ')
        for word in words:
           speaking_patterns.append(word) 
    ...
    for i in range(len(sorted_start_pos_list)):
        ...
        if original_text_lower in singular_first_person_mentions:
            ...
            if i < len(sorted_start_pos_list)-1:
                next_sorted_start_pos = sorted_start_pos_list[i+1]
                next_token = start_pos_to_token[next_sorted_start_pos]
                next_original_text = next_token.text.lower()
                if next_original_text in speaking_patterns:
                    is_valid = False
            if is_valid:
...
#        if (color == 'yellow') and (original_text in singular_first_person_mentions):
...
#        cluster_id = mention_conversion._cluster_id
        if original_text in singular_first_person_mentions:
...
#    print('focus entity cluster id: ')
#    print(cluster_id_for_focus_entity)
#    print('plural first person cluster id: ')
#    print(cluster_id_for_plural_first_person)            
...
def extract_plural_first_person_entity(document_text, start_pos_to_verb_conversion, start_pos_to_mention_conversion, highlight_color_to_cluster_id, shading_color_to_cluster_id, sentences, start_pos_to_token, start_pos_to_sentence_num, sentence_num_to_sent_start_num, cfr_document, cfr_clusters, cfr_index_to_token_index, token_index_to_start_pos):
    plural_first_person_mentions = ['we', 'us', 'our','ourselves', 'ours']
    cluster_id_to_color = get_cluster_id_to_color(highlight_color_to_cluster_id, shading_color_to_cluster_id)
    left_quote_list, right_quote_list = identify_quotes(document_text)
    
    start_pos_to_plural_first_person_mention = {}
    for cluster in cfr_clusters:
        for span in cluster:
            ...
            if temp_mention != ' ' and temp_mention != '\t' and temp_mention != '':
                if temp_mention.lower() in plural_first_person_mentions:
                    token_index = cfr_index_to_token_index[real_start]
                    start_pos = token_index_to_start_pos[token_index]
                    token = start_pos_to_token[start_pos]
                    end_pos = start_pos + len(temp_mention) - 1
                    is_valid = check_mention_in_quotation_and_dialogue(start_pos, end_pos, left_quote_list, right_quote_list)
                    if is_valid:
                        start_pos_to_plural_first_person_mention[start_pos] = token
...
#    cluster_id_for_plural_first_person = -1
#    for start_pos in start_pos_to_mention_conversion:
#        mention_conversion = start_pos_to_mention_conversion[start_pos]
#        original_text = mention_conversion._original_text.lower()
#        cluster_id = mention_conversion._cluster_id
#        color = cluster_id_to_color[cluster_id]
#        if (color == 'yellow') and (original_text in plural_first_person_mentions):
#            cluster_id_for_plural_first_person = cluster_id
#            break
    ...
    for start_pos in start_pos_to_mention_conversion:
        ...
        converted_text = mention_conversion._converted_text.lower()
#        cluster_id = mention_conversion._cluster_id
        if original_text in plural_first_person_mentions:
            if start_pos not in start_pos_to_plural_first_person_mention:
                count1 = count1 + 1
                sentence_num = start_pos_to_sentence_num[start_pos]
                sentence = sentences[sentence_num]
                print("Annotated plural first person mention was not identified: ")
                print("Annotated original text: ")
                print(original_text)
                print("Annotated converted text: ")
                print(converted_text)
                ...
                count2 = count2 + 1
                i_token = start_pos_to_plural_first_person_mention[start_pos]
                if i_token.text.lower() != original_text:
                    count3 = count3 + 1
                    sentence_num = start_pos_to_sentence_num[start_pos]
                    sentence = sentences[sentence_num]
                    print("Not matched plural first person mention: ")
                    print("Annotated original mention: ")
                    print(original_text)
                    print("Identified original mention: ")
                    print(i_token.text)
    ...
    for start_pos in start_pos_to_plural_first_person_mention:
        mention = start_pos_to_plural_first_person_mention[start_pos].text.lower()
        if start_pos not in start_pos_to_mention_conversion:
            count4 = count4 + 1
            sentence_num = start_pos_to_sentence_num[start_pos]
            sentence = sentences[sentence_num]
            print("Identified plural first person mention was not annotated: ")
            print("Identified original mention: ")
            print(mention)
            print("Sentence: ")
            print(sentence)
...
#    print('plural first person cluster id: ')
#    print(cluster_id_for_plural_first_person)            
    print("Annotated plural first person mention conversions that are not identified: ")            
    print(count1)
    print("Annotated plural first person mention conversions that are identified: ")
    print(count2)
    print("Annotated plural first person mention conversions that are identified but incorrectly identified: ")
    print(count3)
    print("Identified plural first person mention conversions that are not annotated: ")
    print(count4)
    print("Identified plural first person mention conversions that are annotated: ")
    print(count5)
    print("Identified plural first person mention conversions that are annotated but incorrectly identified: ")
    print(count6)
    
    return start_pos_to_plural_first_person_mention

def extract_confounding_entities(document_text, start_pos_to_verb_conversion, start_pos_to_mention_conversion, highlight_color_to_cluster_id, shading_color_to_cluster_id, sentences, start_pos_to_token, start_pos_to_sentence_num, sentence_num_to_sent_start_num, cfr_document, cfr_clusters, cfr_index_to_token_index, token_index_to_start_pos, start_pos_to_focus_entity_mention, start_pos_to_plural_first_person_entity_mention, sex):
    ...
    for cluster in cfr_clusters:
        ...
        for span in cluster:
            ...
            if real_start == -1 or real_end == -1:
                print("There is an error - confounding coreference chain 1")
                continue
        ...
        for sp in start_pos_to_mention:
            ...
            for tt in tl:
                if tt[1].text == ' ' or tt[1].text == '\t' or tt[1].text == '':
                    continue
                elif (tt[1].text.lower() in first_person_pronouns) or (tt[1].text.lower() in second_person_pronouns) or (tt[1].text.lower() in third_entity_pronouns):
                    not_valid = True
                    break
            if not_valid:
                break
        ...
        if not_valid and percent < 0.5:
            continue
        
        if contains_third_person_mention or is_person_entity:
    ...
    for cluster_id in cluster_id_to_mention_set:
        ...
        for ss in mention_set:
            ...
            if mm.startswith('my'):
                if sex == 'f':
                    mm = mm.replace('my ', 'her ')
                else:
                    mm = mm.replace('my ', 'his ')
    ...
    for cluster_id in cluster_id_to_mention_set:
        ...
        updated_mention_set = {}         
        for ss in mention_set:           
            if ss in start_pos_to_focus_entity_mention or ss in start_pos_to_plural_first_person_entity_mention:
                continue
            ...
            for pos_and_token in pos_list_and_tokens:
                ...
                if pp in start_pos_to_focus_entity_mention or pp in start_pos_to_plural_first_person_entity_mention:
                    keep_mention = False
                    break
...
#                used_pos_list.append(sorted_pos)
                count2 = count2 + 1
    ...
    for uci in updated_cluster_id_to_mention_set:
        ...
        for ss in ms:
            ...
            if ss not in start_pos_to_mention_conversion:
                ...
                if oo.lower() not in first_person_pronouns:
#                    if ss not in used_pos_list:
#                        print("outsider: ")
#                        print(oo)
#                        print(cc)
#                    if ss not in used_pos_list_2:
#                        used_pos_list_2.append(ss)
#                    else: 
#                        print("overlap: ")
#                        print(oo)
#                        print(cc)
    ...
    return updated_cluster_id_to_mention_set
...
def write_cluster_info(f, start_pos_to_mention_conversion, start_pos_to_focus_entity_mention, start_pos_to_plural_first_person_entity_mention, cluster_id_to_mention_set, focus_mention_string_set, start_pos_to_token, sex):
    valid_cluster_ids = []
    ...
    for start_pos in start_pos_to_focus_entity_mention:
        ...
        if mention_length != 1:
            print("error - double auto first single person")
    ...
    for start_pos in start_pos_to_plural_first_person_entity_mention:
        original_text = start_pos_to_plural_first_person_entity_mention[start_pos].text.lower()
        converted_text = original_text
        tag_list = []
        if start_pos in start_pos_to_mention_conversion:
            mention_conversion = start_pos_to_mention_conversion[start_pos]
        ...
        mention_length = len(original_text.split())  
        if mention_length != 1:
            print("error - double auto first plural person")
        insert_index = sorted_start_pos_list.index(start_pos)
        for iii in range(insert_index,insert_index+mention_length):
            sss = sorted_start_pos_list[iii]
            ttt = start_pos_to_token[sss]
    ...
    for cluster_id in cluster_id_to_mention_set:
        ...
        for start_pos in start_pos_to_mention:
            ...
            if original_text.startswith('my'):
                if sex == 'f':
                    original_text = original_text.replace('my ', 'her ')
                else:
                    original_text = original_text.replace('my ', 'his ')
            converted_text = original_text
            tag_list = []
            if start_pos in start_pos_to_mention_conversion:
                mention_conversion = start_pos_to_mention_conversion[start_pos]
    ...
    for i in range(starting_sent_num, -1, -1):
        if i == starting_sent_num:
            if starting_index >= 100:
                from_token_index = starting_index - 100
                total_token_size = 0
                break
            else:
                total_token_size = 100 - starting_index                            
        else:
...
def get_to_info(starting_sent_num, starting_index, sentences, tokens_list):
    ...
    for i in range(starting_sent_num, len(sentences)):
        ...
        if i == starting_sent_num:
            if starting_index + 101 <= sentence_len:
                to_token_index = starting_index + 100
                total_token_size = 0
                break
            else:
                total_token_size = 101 - (sentence_len - starting_index)
        else:
            if sentence_len >= total_token_size:
                to_sent_num = i
...
def fourth_round_process(pre_padding, post_padding, from_sent_num, to_sent_num, from_token_index, to_token_index, sentences, sent_num_to_mentions, key_to_cluster_id, key_to_original_mention_text, key_to_converted_mention_text, original_mention_len, converted_mention_len, tokens_list, sentence_num_to_token_index_list, token_index_to_start_pos, start_pos_to_mention_conversion, start_pos_to_identified_verb_conversion, invalid_cluster_ids=[]):
    ...
    total_len = 200 + original_mention_len
            ...
            for j in range(from_token_index, len(tokens)):
                ...
                if i in sent_num_to_mentions:
                    ...
                    if m != 0:
                        ...
                        if m == -1:
                            m = 0
                        if len(raw_sequence) - 1 != 100 and len(raw_sequence)-1+m-j <= total_len - 1:
...
def get_sent_num_to_mentions(start_pos_to_sentence_num, start_pos_to_token, start_pos_to_mention_conversion, start_pos_to_verb_conversion, start_pos_to_focus_entity_mention, start_pos_to_plural_first_person_entity_mention, cluster_id_to_mention_set, start_pos_to_identified_verb_conversion, sentence_num_to_token_index_list, token_index_to_start_pos, start_pos_to_cluster_id, start_pos_to_mm, sex):
    ...
    for sent_num in sentence_num_to_token_index_list:
        ...
        for i in range(len(token_index_list)):
            ...
            if start_pos in start_pos_to_focus_entity_mention:
            ...
            elif start_pos in start_pos_to_plural_first_person_entity_mention:
                ot = start_pos_to_plural_first_person_entity_mention[start_pos].text.lower()
                ct = ot
                ci = -2
                if start_pos in start_pos_to_mention_conversion:
                    mc = start_pos_to_mention_conversion[start_pos]
                ...
                if ct.startswith('my'):
                    if sex == 'f':
                        ct = ct.replace('my ', 'her ')
                    else:
                        ct = ct.replace('my ', 'his ')
            ...
            elif ot.lower() in first_person_plural_pronouns:
                identified_key_to_cluster_id[key]=-2
            else:
...
#            if annotated_mention != 0 and identified_mention != 0:
#                ann_men_iden = ann_men_iden + 1
#            elif annotated_mention != 0 and identified_mention == 0:
#                ann_men_not_iden = ann_men_not_iden + 1
#            elif annotated_mention == 0 and identified_mention != 0:
#                iden_men_not_ann = iden_men_not_ann + 1
                ...
                for j in range(from_sent_num, to_sent_num+1):
                    ...
                    for h in range(len(tokens)):
                        ...
                        if temp_start_pos in start_pos_to_identified_verb_conversion:
                            verb_conversion = start_pos_to_identified_verb_conversion[temp_start_pos]
                            temp_original_text = verb_conversion._original_text.lower()
                            tt_oo_tt = start_pos_to_token[temp_start_pos].text.lower()
                            if temp_original_text != tt_oo_tt:
                                print('error - double auto verb')
                            temp_converted_text = verb_conversion._converted_text
                            if temp_converted_text == '':
                                print('empty verb:')
                            to_add_text = temp_converted_text.lower()
...
def main():
    ...
    parser.add_argument('--output_dir',
                    type=str,
                    default='output_data_transformer_auto/',
                    help='output file.')
...
#    output_files=["faraway.txt", "handmaid.txt", "understand.txt"]
    ...
    for i in range(20):
        ...
        start_pos_to_focus_entity_mention = extract_singular_first_person_entity(updated_text, start_pos_to_verb_conversion, start_pos_to_mention_conversion, highlight_color_to_cluster_id, shading_color_to_cluster_id, sentences, start_pos_to_token, start_pos_to_sentence_num) 
        start_pos_to_plural_first_person_entity_mention = extract_plural_first_person_entity(updated_text, start_pos_to_verb_conversion, start_pos_to_mention_conversion, highlight_color_to_cluster_id, shading_color_to_cluster_id, sentences, start_pos_to_token, start_pos_to_sentence_num, sentence_num_to_sent_start_num, cfr_document, cfr_clusters, cfr_index_to_token_index, token_index_to_start_pos)
        ...
        print(temp_set)
        cluster_id_to_mention_set = extract_confounding_entities(updated_text, start_pos_to_verb_conversion, start_pos_to_mention_conversion, highlight_color_to_cluster_id, shading_color_to_cluster_id, sentences, start_pos_to_token, start_pos_to_sentence_num, sentence_num_to_sent_start_num, cfr_document, cfr_clusters, cfr_index_to_token_index, token_index_to_start_pos, start_pos_to_focus_entity_mention, start_pos_to_plural_first_person_entity_mention, sex)  
