...
def write_cluster_info(f, start_pos_to_mention_conversion, highlight_color_to_cluster_id, shading_color_to_cluster_id, focus_mention_string_set, start_pos_to_token):
    ...
    for start_pos in start_pos_to_mention_conversion:
        ...
        if color == 'yellow':
            if mention_length != 1:
                print('error - double gold second person')
            if original_text.lower() in second_person_pronouns:
    ...
    auto_cluster_id_to_mentions[1] = second_person_pronouns
...
def main():
    ...
    parser.add_argument('--output_file',
                    type=str,
                    default='output_data_transformer_gold/narcissist.txt',
                    help='output file.')
