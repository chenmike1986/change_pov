...
class RNNNet2(object):
    ...
    def get_model_testing_data_scenario2(self, f, data_dir, model, margin, gold_setting=False, write_result=False):
        ...
        with torch.no_grad():
            ...
            total_test_entity_mention_not_in_mc = 0
            total_test_se_error = 0
            total_test_mention_selection_error = 0
                    ...
                    for raw_sequence_data in raw_sequence_data_list:   
                        ...
                        if larger_score == 1 and (not no_correct_string_in_se):
                            ...
                            if no_correct_string_in_se:
                                ...
                                if is_test:
                                    total_test_se_error = total_test_se_error + 1
                                ...
                                if in_annotated_mc == 0 and (not gold_setting):
                                    ...
                                    if is_test:
                                        total_test_entity_mention_not_in_mc = total_test_entity_mention_not_in_mc + 1
                                else:
                                    total_mention_selection_error = total_mention_selection_error + 1
                                    if is_test:
                                        total_test_mention_selection_error = total_test_mention_selection_error + 1
                                for mention in mention_set:
                                    if mention.lower() != converted_focus_mention.lower():
                                        if max_index == INDEX:
                                            previous_mentions.append(mention)
        ...
        return valid_losses, total_size, total_correct, total_se_error, total_entity_mention_not_in_mc, total_mention_selection_error, total_test_correct, total_test_se_error, total_test_entity_mention_not_in_mc, total_test_mention_selection_error        
    ...
    def train_and_evaluate_scenario2(self, FLAGS):
        ...
        for i in range(num_epochs):
            ...
            file_name_auto = 'output_f_m2_dev_conll_gold_test_pov_auto' + str(i+1) + ".txt"
            ...
            valid_losses, total_size_test_pov_auto, total_correct_test_pov_auto, total_se_error_test_pov_auto, total_entity_mention_not_in_mc_test_pov_auto, total_mention_selection_error_test_pov_auto, total_test_correct_auto, total_test_se_error_auto, total_test_entity_mention_not_in_mc_auto, total_test_mention_selection_error_auto=self.get_model_testing_data_scenario2(f_auto, pov_auto_testing_data_dir, model, margin, False, True)
            valid_losses = []
            ...
            print('total test correct: ')
            print(total_test_correct_auto)
            print('total se error: ')
            print(total_se_error_test_pov_auto)
            print('total test se error: ')
            print(total_test_se_error_auto)
            print('total entity not in mc: ')
            print(total_entity_mention_not_in_mc_test_pov_auto)
            print('total test entity not in mc: ')
            print(total_test_entity_mention_not_in_mc_auto)
            print('total mention selection error: ')
            print(total_mention_selection_error_test_pov_auto+total_entity_mention_not_in_mc_test_pov_auto)
            print('total test mention selection error: ')
            print(total_test_mention_selection_error_auto+total_test_entity_mention_not_in_mc_auto)
            ...
            f_output.write('total test correct: ')
            f_output.write('\n')
            f_output.write(str(total_test_correct_auto))
            f_output.write('\n')
            f_output.write('total se error: ')
            f_output.write('\n')
            f_output.write(str(total_se_error_test_pov_auto))
            f_output.write('\n')
            f_output.write('total test se error: ')
            f_output.write('\n')
            f_output.write(str(total_test_se_error_auto))
            f_output.write('\n')
            f_output.write('total entity not in mc: ')
            f_output.write('\n')
            f_output.write(str(total_entity_mention_not_in_mc_test_pov_auto))
            f_output.write('\n')
            f_output.write('total test entity not in mc: ')
            f_output.write('\n')
            f_output.write(str(total_test_entity_mention_not_in_mc_auto))
            f_output.write('\n')
            f_output.write('total mention selection error: ')
            f_output.write('\n')
            ...
            f_output.write('total test mention selection error: ')
            f_output.write('\n')
            f_output.write(str(total_test_mention_selection_error_auto+total_test_entity_mention_not_in_mc_auto))
            f_output.write('\n')
...
def main():
    ...
    parser.add_argument('--development_data_dir',
                    type=str,
                    default='mention_predictor/preprocess/preprocess_conll_data/output_conll_data/dev/',
