            ...
            for raw_sequence_data in raw_sequence_data_list:    
                ...
                if len(seql_1_list) >= 512:
                    ...
                    if max_seql_length_1 >= max_seql_length_2:
                        self.max_seql_length = max_seql_length_1 + 1
                    else:
                        self.max_seql_length = max_seql_length_2 + 1
